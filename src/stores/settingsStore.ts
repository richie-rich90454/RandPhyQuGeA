...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      setSpecification: (path, content) =>
        set({ specificationPath: path, specificationContent: content }),
      setDefaultDifficulties: (difficulties) =>
        set({ defaultDifficulties: difficulties }),
      setDefaultQuestionCount: (count) =>
        set({ defaultQuestionCount: count }),
      setHapticEnabled: (enabled) => set({ hapticEnabled: enabled }),
      setSoundEnabled: (enabled) => set({ soundEnabled: enabled }),
      setOnboardingCompleted: (completed) =>
        set({ onboardingCompleted: completed }),
      clearSpecification: () =>
        set({ specificationPath: '', specificationContent: '' }),
    }),
    {
