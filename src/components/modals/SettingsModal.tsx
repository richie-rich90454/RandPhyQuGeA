 ...
 * Data (reset to defaults). All values read from and write to the
 * persisted settingsStore so changes apply immediately and survive reload.
 */
			...
			{activeTab === 'advanced' && (
				<div id="settings-advanced" role="tabpanel" aria-labelledby="settings-tab-advanced" tabIndex={0} className="settings-panel">
					...
					<div className="settings-section">
						<h3>Data</h3>
						<div className="setting-item">
							<button type="button" className="secondary-button" id="settings-reset" onClick={settings.resetToDefaults}>
								Reset to defaults
							</button>
						</div>
					</div>
